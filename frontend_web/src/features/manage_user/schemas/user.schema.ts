import z from "zod";
import { ROLES, type TendikRole } from "@/constants/roles";
export { ROLES, type TendikRole };
export { z };
...
export const CreateTendikSchema = z.object({
    tendik: z.array(z.object({
        ...
        role: z.enum([ROLES.ADMIN, ROLES.KESISWAAN, ROLES.BK, ROLES.KEPSEK], { message: "Role not valid'" }),
...
export const UpdateTendikSchema = z.object({
    ...
    role: z.enum([ROLES.ADMIN, ROLES.KESISWAAN, ROLES.BK, ROLES.KEPSEK], { message: "Jabatan is required" }),
})
