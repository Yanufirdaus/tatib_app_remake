...
const MenuSection = () => {
    ...
    return (
        <div className="md:basis-1/5 flex flex-col min-h-12 md:min-h-screen min-w-screen md:min-w-auto items-center justify-center bg-[#537D96] md:bg-[#537D96]">
            <button
            ...
            {open && (
                <div className="flex flex-col gap-4 md:hidden justify-center items-center bg-gray-800 w-full py-4">
                    <a className="text-white" onClick={() => { navigate("/manajemen-siswa") }}>Manajemen Siswa</a>
                    <a className="text-white" onClick={() => { navigate("/manajemen-tendik") }}>Manajemen Tendik</a>
            ...
            <div className="hidden md:flex md:flex-col gap-8 text-white md:w-5/5">
                <a className="text-white hover:bg-gray-800 md:px-8 py-4" onClick={() => { navigate("/manajemen-siswa") }}>Manajemen Siswa</a>
                <a className="text-white hover:bg-gray-800 md:px-8 py-4" onClick={() => { navigate("/manajemen-tendik") }}>Manajemen Tendik</a>
